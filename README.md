...
My project will be based on a database which allows user to input data for video games that were released during the 90s. It will show the games released during this period and what platfrom that were capable to play them on.
